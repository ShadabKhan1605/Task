...
protocol RecentReminder: AnyObject {
    func didTapSaveBtn(detailedTask: String, task: String,time:Date)
}
...
class SetReminderPG: UIViewController {
    ...
    @IBAction func saveBTN(_ sender: UIButton) {
        ...
        selectedReminderDate = Datepicker.date
        delegate?.didTapSaveBtn(detailedTask: detailText, task: taskText,time: selectedReminderDate!)
        ...
        vc.reminderDate = selectedReminderDate 
